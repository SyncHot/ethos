...
def init_appstore(sio):
    ...
    try:
        from blueprints.appstore_validation import init_appstore_validation
        from blueprints.appstore_publish import init_appstore_publish
        init_appstore_validation(_socketio)
        init_appstore_publish(_socketio)
    except ImportError as e:
        log.warning('Could not initialize appstore sub-modules: %s', e)
...
#  Sub-modules are imported and initialized in init_appstore()
# ════════════════════════════════════════════════════════════
